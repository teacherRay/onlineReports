		...
		<div class="col-md-6 col-md-offset-3">
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
				    ...
				    Classroom:<input type="number" class="form-control" name="classroom" placeholder="Enter Student classroom" required>
				  </div>
...
<?php 
	...
	if (isset($_POST['submit'])) {
		if (!empty($_POST['roll']) && !empty($_POST['fullname'])) {
			...
			$sql = "INSERT INTO `student`( `rollno`, `name`, `city`, `pcontact`, `classroom`,`image`) VALUES ('$roll','$name','$city','$pphone',$classroom,'$imgName')";
